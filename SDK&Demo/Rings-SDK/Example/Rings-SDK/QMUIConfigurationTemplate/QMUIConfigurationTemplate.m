...
- (void)applyConfigurationTemplate {
    ...
    QMUICMI.navBarShadowImage = [UIImage qmui_imageWithColor:UIColorClear];                                            // NavBarShadowImage : UINavigationBar.shadowImage，也即导航栏底部那条分隔线，配合 NavBarShadowImageColor 使用。不能设置为[UIImage new]，不起作用
    ...
    QMUICMI.navBarTitleFont = [UIFont qmui_mediumSystemFontOfSize:22];                                              // NavBarTitleFont : UINavigationBar 的标题字体，以及 QMUINavigationTitleView 的默认字体
    ...
    QMUICMI.tabBarShadowImageColor = UIColorWhite;                                       // TabBarShadowImageColor : UITabBar 的 shadowImage 的颜色，会自动创建一张 1px 高的图片
