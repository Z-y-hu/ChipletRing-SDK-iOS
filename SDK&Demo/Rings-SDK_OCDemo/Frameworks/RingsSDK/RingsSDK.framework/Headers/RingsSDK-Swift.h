...
#ifndef RINGSSDK_SWIFT_H
#define RINGSSDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="RingsSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

#if defined(__OBJC__)

SWIFT_CLASS("_TtC8RingsSDK13ApolloOTATool")
@interface ApolloOTATool : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


@interface ApolloOTATool (SWIFT_EXTENSION(RingsSDK)) <AmotaApiUpdateAppDataDelegate>
- (void)didAmOtaFwHeaderRsp:(eAmotaStatus)status;
- (void)didAmOtaFwDataRsp:(eAmotaStatus)status withDataLengthSent:(uint32_t)length;
- (void)didAmOtaUserCmdRsp:(eAmotaUserCmd)cmd withStatus:(eAmotaStatus)status;
@end

@class NSString;

/// 适配OC
SWIFT_CLASS("_TtC8RingsSDK5BDLog")
...
SWIFT_CLASS("_TtC8RingsSDK10DeviceInfo")
...
SWIFT_CLASS("_TtC8RingsSDK13RingDBManager")
@interface RingDBManager : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
@property (nonatomic) uint32_t total;
@property (nonatomic) uint32_t serialNum;
@property (nonatomic) uint32_t timestamp;
@property (nonatomic) uint16_t stepsOfTheDay;
...
SWIFT_CLASS("_TtC8RingsSDK11RingManager")
...
SWIFT_CLASS("_TtC8RingsSDK14RingSleepModel")
@interface RingSleepModel : NSObject
/// 零星睡眠小时
...
/// 睡眠数据
@property (nonatomic, copy) NSArray<RingDataModel *> * _Nonnull sleepDataList;
@property (nonatomic, readonly, copy) NSString * _Nonnull description;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
